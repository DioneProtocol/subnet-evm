...
// RegisterNodeRun registers a before suite that starts an OdysseyGo process to use for the e2e tests
// and an after suite that stops the OdysseyGo process
func RegisterNodeRun() {
	// BeforeSuite starts an OdysseyGo process to use for the e2e tests
